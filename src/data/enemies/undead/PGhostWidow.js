export const PGhostWidow = {
  ...
  life: 4,
  maxLife: 4,
  id: "UNDEAD|purple|Ghost Widow",
  body: [
    {
      priority: true, //priority, extra, keep, once
      bodyPartIcon: "🐾",
      bodyPartTypes: ["paws", "body"],
      id: "piece|UNDEAD|purple|Ghost Widow|paws|1",
      weakness: ["physical"],
      damages: {
        // damageToPlayer: 1,
        // damageToEnemy: 1,
    ...
    },
    {
      ...
      id: "piece|UNDEAD|purple|Ghost Widow|head|1",
      // weakness: ["physical"],
      damages: {
        damageToPlayer: 2,
        // damageToEnemy: 1,
    ...
    },
    {
      ...
      id: "piece|UNDEAD|purple|Ghost Widow|torso|1",
      // weakness: ["physical"],
      damages: {
        // damageToPlayer: 1,
        damageToEnemy: 1,
    ...
    },
    {
      ...
      bodyPartIcon: "🐭",
      bodyPartTypes: ["head", "body"],
      id: "piece|UNDEAD|purple|Ghost Widow|head|2",
      weakness: ["physical"],
      damages: {
        damageToPlayer: 1,
        damageToEnemy: 1,
